...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('test_tone_skins', function(table) {
    ...
    table.string('volume_path').notNullable().defaultTo('');
    table.string('volume_size').notNullable().defaultTo('');
    table.string('volume_repeat').notNullable().defaultTo('no-repeat');
    table.string('volume_box_shadow_color').notNullable().defaultTo('');
    table.string('volume_slider_path').notNullable().defaultTo('');
    table.string('volume_slider_size').notNullable().defaultTo('');
    table.string('volume_slider_repeat').notNullable().defaultTo('no-repeat');
    table.string('volume_slider_box_shadow_color').notNullable().defaultTo('');
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTable('test_tone_skins');
};
