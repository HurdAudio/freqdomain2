...
function visualMuting() {
  ...
  if (muteAll) {
    ...
    setTimeout(()=>{
      if (muteAll) {
        masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/april/jarrod-reed-401911-unsplash.jpg); background-size: 300%; color: transparent; box-shadow: -1px -1px 1px #ffb2b2, -2px -2px 1px #99e099, -3px -3px 1px #99e099, -4px -4px 1px #99e099;");
    ...
    masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/april/jarrod-reed-401911-unsplash.jpg); background-size: 300%; color: #000000; box-shadow: -1px -1px 1px #99e099, -2px -2px 1px #99e099, -3px -3px 1px #99e099, -4px -4px 1px #99e099;");
    masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #99e099, -2px -2px 1px #99e099, -3px -3px 1px #99e099;");
    muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #99e099, -2px -2px 1px #99e099;");
