...
function visualMuting() {
  ...
  if (muteAll) {
    ...
    setTimeout(()=>{
      if (muteAll) {
        masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/may/panuson-norkaew-696399-unsplash.jpg); background-size: 300%; color: transparent; box-shadow: -1px -1px 1px #66d4ff, -2px -2px 1px #66d4ff, -3px -3px 1px #66d4ff, -4px -4px 1px #66d4ff;");
    ...
    masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/may/panuson-norkaew-696399-unsplash.jpg); background-size: 300%; color: #000000; box-shadow: -1px -1px 1px #66d4ff, -2px -2px 1px #66d4ff, -3px -3px 1px #66d4ff, -4px -4px 1px #66d4ff;");
    masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #66d4ff, -2px -2px 1px #66d4ff, -3px -3px 1px #66d4ff;");
    muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #66d4ff, -2px -2px 1px #66d4ff;");
