...
function visualMuting() {
  ...
  if (muteAll) {
    ...
    setTimeout(()=>{
      if (muteAll) {
        masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/may/wolfgang-hasselmann-704553-unsplash.jpg); background-size: 300%; color: transparent; box-shadow: -1px -1px 1px #ffff32, -2px -2px 1px #ffff32, -3px -3px 1px #ffff32, -4px -4px 1px #ffff32;");
        masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #ffff32, -2px -2px 1px #ffff32, -3px -3px 1px #ffff32;");
        muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #ffff32, -2px -2px 1px #ffff32;");
        setTimeout(()=>{
          if (muteAll) {
            visualMuting();
          }
    ...
    masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/may/wolfgang-hasselmann-704553-unsplash.jpg); background-size: 300%; color: #000000; box-shadow: -1px -1px 1px #ffff32, -2px -2px 1px #ffff32, -3px -3px 1px #ffff32, -4px -4px 1px #ffff32;");
    masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #ffff32, -2px -2px 1px #ffff32, -3px -3px 1px #ffff32;");
    muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #ffff32, -2px -2px 1px #ffff32;");
