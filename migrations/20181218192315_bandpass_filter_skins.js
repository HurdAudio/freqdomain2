...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('bandpass_filter_skins', function(table) {
    ...
    table.string('q_box_shadow_color').notNullable().defaultTo('#000000');
    table.string('q_font_color').notNullable().defaultTo('#000000');
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTable('bandpass_filter_skins');
};
