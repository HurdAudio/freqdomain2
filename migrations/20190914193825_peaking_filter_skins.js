...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('peaking_filter_skins', function(table) {
    ...
    table.string('q_size').notNullable().defaultTo('');
    table.string('q_repeat').notNullable().defaultTo('no-repeat');
    table.string('q_box_shadow_color').notNullable().defaultTo('');
    table.string('q_font_color').notNullable().defaultTo('#0000000');
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTable('peaking_filter_skins');
};
