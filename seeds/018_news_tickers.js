  ...
  return knex('news_tickers').del()
    .then(function () {
      ...
      return knex('news_tickers').insert([
        ...
        {
          id: 3,
          headline: 'Currently working on: Weather Module (module 10). Stage 8 - February Consequence - Skins Table with migration/seeds/routes. January and February skins added.',
          expired: false,
          created_at: new Date('2017-07-20T13:44:00.000Z'),
          updated_at: new Date('2017-07-20T13:44:00.000Z')
        }
