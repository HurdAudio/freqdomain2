    ...
    .then(function () {
      ...
      return knex('gain_skins').insert([
        ...
        },
        {
          ...
          face_path: '../img/may/d-a-v-i-d-s-o-n-l-u-n-a-664928-unsplash.jpg',
          face_size: '150%',
          face_repeat: 'no-repeat',
          face_box_shadow_color: '#adadff',
          face_font_color: '#0a0a33',
          face_font_shadow: '#adadff',
          top_path: '../img/may/mitchell-griest-622892-unsplash.jpg',
          top_size: '100%',
          top_repeat: 'no-repeat',
          top_font_color: '#0a0a33',
          top_font_shadow: '#adadff',
          signal_path: '../img/may/mitchell-griest-622892-unsplash.jpg',
          signal_size: '100%',
          signal_repeat: 'no-repeat',
          signal_box_shadow_color: '#adadff',
          signal_font_color: '#0a0a33',
          signal_font_shadow: '#adadff',
          display_path: '../img/may/patrick-hendry-775890-unsplash.jpg',
          input_size: '1000%',
          input_repeat: 'no-repeat',
          input_box_shadow_color: '#adadff',
          input_font_color: '#0a0a33',
          ...
          gain_volume_repeat: 'no-repeat',
          gain_volume_box_shadow: '#adadff',
          gain_slider_path: '../img/may/patrick-hendry-775890-unsplash.jpg',
          gain_modulator_select_path: '../img/may/patrick-hendry-775890-unsplash.jpg',
          gain_modulator_select_size: '200%',
          gain_modulator_select_repeat: 'no-repeat',
          gain_modulator_select_box_shadow_color: '#adadff',
          gain_modulator_edit_box_shadow_color: '#adadff',
        ...
        },
        {
          ...
          face_path: '../img/may/matthew-kalapuch-621456-unsplash.jpg',
          face_size: '150%',
          face_repeat: 'no-repeat',
          face_box_shadow_color: '#e34f4f',
          face_font_color: '#160707',
          face_font_shadow: '#e34f4f',
          top_path: '../img/may/alex-keda-11242-unsplash.jpg',
          top_size: '100%',
          top_repeat: 'no-repeat',
          top_font_color: '#160707',
          top_font_shadow: '#e34f4f',
          signal_path: '../img/may/alex-keda-11242-unsplash.jpg',
          signal_size: '1100%',
          signal_repeat: 'no-repeat',
          signal_box_shadow_color: '#e34f4f',
          signal_font_color: '#160707',
          signal_font_shadow: '#e34f4f',
          display_path: '../img/may/vadim-gromov-3454-unsplash.jpg',
          input_size: '1000%',
          input_repeat: 'no-repeat',
          input_box_shadow_color: '#e34f4f',
          input_font_color: '#160707',
          input_font_shadow: '#e34f4f',
          output_size: '1000%',
          output_repeat: 'no-repeat',
          output_box_shadow_color: '#e34f4f',
          output_font_color: '#160707',
          output_font_shadow: '#e34f4f',
          gain_display_size: '100%',
          gain_display_repeat: 'no-repeat',
          gain_display_box_shadow_color: '#e34f4f',
          gain_display_font_color: '#160707',
          gain_volume_size: '100%',
          gain_volume_repeat: 'no-repeat',
          gain_volume_box_shadow: '#e34f4f',
          gain_slider_path: '../img/may/vadim-gromov-3454-unsplash.jpg',
          gain_modulator_select_path: '../img/may/vadim-gromov-3454-unsplash.jpg',
          gain_modulator_select_size: '200%',
          gain_modulator_select_repeat: 'no-repeat',
          gain_modulator_select_box_shadow_color: '#e34f4f',
          gain_modulator_edit_box_shadow_color: '#e34f4f',
          created_at: new Date('2017-07-20T13:44:00.000Z'),
          updated_at: new Date('2017-07-20T13:44:00.000Z')
        },
        {
          ...
          face_path: '../img/may/ferns-2178641_1920.jpg',
          face_size: '150%',
          face_repeat: 'no-repeat',
          face_box_shadow_color: '#ffe135',
          face_font_color: '#332d0a',
          face_font_shadow: '#ffe135',
          top_path: '../img/may/leaf-3291039_1920.jpg',
          top_size: '100%',
          top_repeat: 'no-repeat',
          top_font_color: '#332d0a',
          top_font_shadow: '#ffe135',
          signal_path: '../img/may/leaf-3291039_1920.jpg',
          signal_size: '1100%',
          signal_repeat: 'no-repeat',
          signal_box_shadow_color: '#ffe135',
          signal_font_color: '#332d0a',
          signal_font_shadow: '#ffe135',
          display_path: '../img/may/background-1868854_1920.jpg',
          input_size: '1000%',
          input_repeat: 'no-repeat',
          input_box_shadow_color: '#ffe135',
          input_font_color: '#332d0a',
          input_font_shadow: '#ffe135',
          output_size: '1000%',
          output_repeat: 'no-repeat',
          output_box_shadow_color: '#ffe135',
          output_font_color: '#332d0a',
          output_font_shadow: '#ffe135',
          gain_display_size: '100%',
          gain_display_repeat: 'no-repeat',
          gain_display_box_shadow_color: '#ffe135',
          gain_display_font_color: '#332d0a',
          gain_volume_size: '100%',
          gain_volume_repeat: 'no-repeat',
          gain_volume_box_shadow: '#ffe135',
          gain_slider_path: '../img/may/background-1868854_1920.jpg',
          gain_modulator_select_path: '../img/may/background-1868854_1920.jpg',
          gain_modulator_select_size: '200%',
          gain_modulator_select_repeat: 'no-repeat',
          gain_modulator_select_box_shadow_color: '#ffe135',
          gain_modulator_edit_box_shadow_color: '#ffe135',
          created_at: new Date('2017-07-20T13:44:00.000Z'),
          updated_at: new Date('2017-07-20T13:44:00.000Z')
        }
      ]);
