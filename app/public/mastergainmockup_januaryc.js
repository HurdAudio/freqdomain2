...
function visualMuting() {
  ...
  if (muteAll) {
    ...
    masterGainDisplay.setAttribute("style", "background: #ff0000; background-color: -webkit-linear-gradient(135deg, #ff0000, #6FAAF0); background: -o-linear-gradient(135deg, #ff0000, #6FAAF0); background: -moz-linear-gradient(135deg, #ff0000, #6FAAF0); background: linear-gradient(135deg, #ff0000, #6FAAF0); color: transparent; box-shadow: -1px -1px 1px #DAA520, -2px -2px 1px #DAA520, -3px -3px 1px #DAA520, -4px -4px 1px #DAA520;");
    masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #DAA520, -2px -2px 1px #DAA520, -3px -3px 1px #DAA520");
    muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #DAA520;");
    masterGainTop.setAttribute("style", "filter: hue-rotate(90deg);");
    masterGainInput.setAttribute("style", "filter: hue-rotate(90deg);");
    setTimeout(()=>{
      if (muteAll) {
        masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/january/masterVolumeDisplayFace.jpg); background-size: 300%; color: transparent; box-shadow: -1px -1px 1px #ff0000, -2px -2px 1px #DAA520, -3px -3px 1px #DAA520, -4px -4px 1px #DAA520;");
        masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #ff0000, -2px -2px 1px #ff0000, -3px -3px 1px #ff0000;");
        muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #DAA520, -2px -2px 1px #DAA520;");
        setTimeout(()=>{
          if (muteAll) {
            visualMuting();
          }
    ...
    masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/january/ice_ground_texture_by_hhh316-d5imitg.jpg); background-size: 300%; color: #000000; box-shadow: -1px -1px 1px #DAA520, -2px -2px 1px #DAA520, -3px -3px 1px #DAA520, -4px -4px 1px #DAA520;");
    masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #DAA520, -2px -2px 1px #DAA520, -3px -3px 1px #DAA520;");
    muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #DAA520, -2px -2px 1px #DAA520;");
