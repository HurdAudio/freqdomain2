...
function visualMuting() {
  ...
  if (muteAll) {
    ...
    masterGainDisplay.setAttribute("style", "background: #ffb2b2; background-color: -webkit-linear-gradient(135deg, #ffb2b2, #e50000); background: -o-linear-gradient(135deg, #ffb2b2, #e50000); background: -moz-linear-gradient(135deg, #ffb2b2, #e50000); background: linear-gradient(135deg, #ffb2b2, #e50000); color: transparent; box-shadow: -1px -1px 1px #ff3232, -2px -2px 1px #ff3232, -3px -3px 1px #ff3232, -4px -4px 1px #ff3232;");
    masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #ff3232, -2px -2px 1px #ff3232, -3px -3px 1px #ff3232");
    muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #ff3232;");
    masterGainTop.setAttribute("style", "filter: hue-rotate(90deg);");
    masterGainInput.setAttribute("style", "filter: hue-rotate(90deg);");
    setTimeout(()=>{
      if (muteAll) {
        masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/march/Tikkurila_Taika_Paint_silver.jpg); background-size: 300%; color: transparent; box-shadow: -1px -1px 1px #ffb2b2, -2px -2px 1px #ff3232, -3px -3px 1px #ff3232, -4px -4px 1px #ff3232;");
        masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #ffb2b2, -2px -2px 1px #ffb2b2, -3px -3px 1px #ffb2b2;");
        muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #ff3232, -2px -2px 1px #ff3232;");
        setTimeout(()=>{
          if (muteAll) {
            visualMuting();
          }
    ...
    masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/march/Tikkurila_Taika_Paint_silver.jpg); background-size: 300%; color: #000000; box-shadow: -1px -1px 1px #ff3232, -2px -2px 1px #ff3232, -3px -3px 1px #ff3232, -4px -4px 1px #ff3232;");
    masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #ff3232, -2px -2px 1px #ff3232, -3px -3px 1px #ff3232;");
    muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #ff3232, -2px -2px 1px #ff3232;");
