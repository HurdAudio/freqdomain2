...
function visualMuting() {
  ...
  if (muteAll) {
    ...
    setTimeout(()=>{
      if (muteAll) {
        masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/june/krisztian-tabori-nZGNVOvEYio-unsplash.jpg); background-size: 300%; color: transparent; box-shadow: -1px -1px 1px #4cfb31, -2px -2px 1px #4cfb31, -3px -3px 1px #4cfb31, -4px -4px 1px #4cfb31;");
    ...
    masterGainDisplay.setAttribute("style", "background-color: transparent; background: url(./img/june/krisztian-tabori-nZGNVOvEYio-unsplash.jpg); background-size: 300%; color: #000000; box-shadow: -1px -1px 1px #4cfb31, -2px -2px 1px #4cfb31, -3px -3px 1px #4cfb31, -4px -4px 1px #4cfb31;");
    masterGainFace.setAttribute("style", "box-shadow: -1px -1px 1px #4cfb31, -2px -2px 1px #4cfb31, -3px -3px 1px #4cfb31;");
    muteNote.setAttribute("style", "text-shadow: -1px -1px 1px #4cfb31, -2px -2px 1px #4cfb31;");
