...
router.post('/', (req, res, next) => {
  ...
  .insert({
    ...
    gain_size: req.body.gain_size,
    gain_repeat: req.body.gain_repeat,
    gain_box_shadow_color: req.body.gain_box_shadow_color,
    gain_font_color: req.body.gain_font_color,
    ...
    let record;
      ...
      knex('highshelf_filter_skins')
        ...
        .then((row) => {
          ...
          return knex('highshelf_filter_skins')
            .del()
            .where('id', req.params.id);
        })
        .then(() => {
          ...
          var obj = {
            ...
            gain_size: record.gain_size,
            gain_repeat: record.gain_repeat,
            gain_box_shadow_color: record.gain_box_shadow_color,
            gain_font_color: record.gain_font_color,
