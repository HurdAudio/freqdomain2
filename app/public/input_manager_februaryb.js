  ...
  muteSlider.addEventListener('change', ()=>{
    if (muteSlider.value !== 0) {
      ...
      if (solos[ch-1]) {
        ...
        muteDisplay.setAttribute("style", "background: url(./img/february/rawpixel-584299-unsplash.jpg); background-size: 200%;");
      }
    }
  });
...
function monitorSoloButton(soloButton, rudeChannel) {
  ...
  soloButton.addEventListener('click', ()=>{
    if (solos[rudeChannel - 1]) {
      ...
      document.getElementById('gainStripDisplay' + rudeChannel).setAttribute("style", "background: url(./img/february/rawpixel-584299-unsplash.jpg); background-size: 200%;");
