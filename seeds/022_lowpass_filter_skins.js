  ...
  return knex('lowpass_filter_skins').del()
    .then(function () {
      ...
      return knex('lowpass_filter_skins').insert([
        ...
        {
          id: 10,
          name: 'Lowpass Filter: April A',
          month: 'april',
          rule: {
            "dates": [ 1, 2, 4, 6, 8, 11, 12, 14, 21, 22 ]
          },
          face_path: '../img/april/greg-rosenke-1383960-unsplash.jpg',
          face_size: '100%',
          face_repeat: 'no-repeat',
          face_box_shadow_color: '#ef4545',
          face_font_color: '#170202',
          face_font_shadow_color: '#ef4545',
          top_path: '../img/april/borna-bevanda-316434-unsplash.jpg',
          top_size: '110%',
          top_repeat: 'no-repeat',
          top_font_color: '#170202',
          top_font_shadow_color: '#ef4545',
          signal_path: '../img/april/borna-bevanda-316434-unsplash.jpg',
          signal_size: '1800%',
          signal_repeat: 'no-repeat',
          signal_box_shadow_color: '#ef4545',
          signal_font_color: '#170202',
          signal_font_shadow_color: '#ef4545',
          display_path: '../img/april/harli-marten-140106-unsplash.jpg',
          input_size: '200%',
          input_repeat: 'no-repeat',
          input_box_shadow_color: '#ef4545',
          input_font_color: '#170202',
          input_font_shadow_color: '#ef4545',
          output_size: '200%',
          output_repeat: 'no-repeat',
          output_box_shadow_color: '#ef4545',
          output_font_color: '#170202',
          output_font_shadow_color: '#ef4545',
          frequency_display_size: '100%',
          frequency_display_repeat: 'no-repeat',
          frequency_display_box_shadow_color: '#ef4545',
          frequency_display_font_color: '#170202',
          detune_size: '100%',
          detune_repeat: 'no-repeat',
          detune_box_shadow_color: '#ef4545',
          detune_font_color: '#170202',
          q_size: '100%',
          q_repeat: 'no-repeat',
          q_box_shadow_color: '#ef4545',
          q_font_color: '#170202',
          mod_select_size: '100%',
          mod_repeat_value: 'no-repeat',
          slider_size: '200%',
          slide_repeat_value: 'no-repeat',
          slider_shader_color_1: '#8d0d0d',
          slider_shader_color_2: '#f37373',
          created_at: new Date('2017-07-20T13:44:00.000Z'),
          updated_at: new Date('2017-07-20T13:44:00.000Z')
        },
        {
          id: 11,
          name: 'Lowpass Filter: April B',
          month: 'april',
          rule: {
            "dates": [ 7, 9, 10, 16, 18, 24, 26, 27, 28, 29 ]
          },
          face_path: '../img/april/jeremy-bishop-14593-unsplash.jpg',
          face_size: '100%',
          face_repeat: 'no-repeat',
          face_box_shadow_color: '#f5f54b',
          face_font_color: '#181805',
          face_font_shadow_color: '#f5f54b',
          top_path: '../img/april/marco-saavedra-1144558-unsplash.jpg',
          top_size: '110%',
          top_repeat: 'no-repeat',
          top_font_color: '#181805',
          top_font_shadow_color: '#f5f54b',
          signal_path: '../img/april/marco-saavedra-1144558-unsplash.jpg',
          signal_size: '1800%',
          signal_repeat: 'no-repeat',
          signal_box_shadow_color: '#f5f54b',
          signal_font_color: '#181805',
          signal_font_shadow_color: '#f5f54b',
          display_path: '../img/april/oz-mlcn-1346609-unsplash.jpg',
          input_size: '800%',
          input_repeat: 'no-repeat',
          input_box_shadow_color: '#f5f54b',
          input_font_color: '#181805',
          input_font_shadow_color: '#f5f54b',
          output_size: '800%',
          output_repeat: 'no-repeat',
          output_box_shadow_color: '#f5f54b',
          output_font_color: '#181805',
          output_font_shadow_color: '#f5f54b',
          frequency_display_size: '100%',
          frequency_display_repeat: 'no-repeat',
          frequency_display_box_shadow_color: '#f5f54b',
          frequency_display_font_color: '#181805',
          detune_size: '100%',
          detune_repeat: 'no-repeat',
          detune_box_shadow_color: '#f5f54b',
          detune_font_color: '#181805',
          q_size: '100%',
          q_repeat: 'no-repeat',
          q_box_shadow_color: '#f5f54b',
          q_font_color: '#181805',
          mod_select_size: '100%',
          mod_repeat_value: 'no-repeat',
          slider_size: '200%',
          slide_repeat_value: 'no-repeat',
          slider_shader_color_1: '#7a7a1c',
          slider_shader_color_2: '#f7f773',
          created_at: new Date('2017-07-20T13:44:00.000Z'),
          updated_at: new Date('2017-07-20T13:44:00.000Z')
        },
        {
          id: 12,
          name: 'Lowpass Filter: April C',
          month: 'april',
          rule: {
            "dates": [ 3, 5, 13, 15, 17, 19, 20, 23, 25, 30 ]
          },
          face_path: '../img/april/thomas-park-1616693-unsplash.jpg',
          face_size: '100%',
          face_repeat: 'no-repeat',
          face_box_shadow_color: '#fd3a3a',
          face_font_color: '#320b0b',
          face_font_shadow_color: '#fd3a3a',
          top_path: '../img/april/lisa-knight-1491554-unsplash.jpg',
          top_size: '110%',
          top_repeat: 'no-repeat',
          top_font_color: '#320b0b',
          top_font_shadow_color: '#fd3a3a',
          signal_path: '../img/april/lisa-knight-1491554-unsplash.jpg',
          signal_size: '1800%',
          signal_repeat: 'no-repeat',
          signal_box_shadow_color: '#fd3a3a',
          signal_font_color: '#320b0b',
          signal_font_shadow_color: '#fd3a3a',
          display_path: '../img/april/enrique-ortega-miranda-1597828-unsplash.jpg',
          input_size: '800%',
          input_repeat: 'no-repeat',
          input_box_shadow_color: '#fd3a3a',
          input_font_color: '#320b0b',
          input_font_shadow_color: '#fd3a3a',
          output_size: '800%',
          output_repeat: 'no-repeat',
          output_box_shadow_color: '#fd3a3a',
          output_font_color: '#320b0b',
          output_font_shadow_color: '#fd3a3a',
          frequency_display_size: '100%',
          frequency_display_repeat: 'no-repeat',
          frequency_display_box_shadow_color: '#fd3a3a',
          frequency_display_font_color: '#320b0b',
          detune_size: '100%',
          detune_repeat: 'no-repeat',
          detune_box_shadow_color: '#fd3a3a',
          detune_font_color: '#320b0b',
          q_size: '100%',
          q_repeat: 'no-repeat',
          q_box_shadow_color: '#fd3a3a',
          q_font_color: '#320b0b',
          mod_select_size: '100%',
          mod_repeat_value: 'no-repeat',
          slider_size: '200%',
          slide_repeat_value: 'no-repeat',
          slider_shader_color_1: '#972222',
          slider_shader_color_2: '#fd8888',
          created_at: new Date('2017-07-20T13:44:00.000Z'),
          updated_at: new Date('2017-07-20T13:44:00.000Z')
        }
      ]);
